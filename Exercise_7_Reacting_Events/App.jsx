...
function App() {
    ...
    function handleLogin() {
        ...
        console.log("Before Login Blank " + user.email);
        console.log("Before Login Blank " + user.password);
    
        user.email = 'New Email';
        user.password = 'New Passoword';
        user.loggedIn = true;
       
        console.log("After Login Username = " + user.email);
        console.log("Before Login Password = " + user.password);;
    }
